...
function do_patch_doom
{
    ...
    local artifact_url="https://github.com/sysprog21/rv32emu-prebuilt/blob/655ff89eea0d866c58efa9b6ab1b19dab4aebab7/shareware_doom_iwad.zip?raw=true"
    ...
    sed -i 's/--specs=nano\.specs//g' ${SRC_DIR}/buildroot/package/${pkg_name}/src/riscv/Makefile
    sed -i 's/-Bstatic,//g' ${SRC_DIR}/buildroot/package/${pkg_name}/src/riscv/Makefile
    # rename output binary from doom-riscv.elf to doom
    sed -i 's/doom-riscv\.elf/doom/g' ${SRC_DIR}/buildroot/package/${pkg_name}/src/riscv/Makefile
...
function do_patch_quake
{
    ...
    local artifact_url="https://www.libsdl.org/projects/quake/data/quakesw-1.0.6.zip"
